...
function More() {
  ...
  return (
    <>
      <Head>
        <title>More Fitness Tools & Resources | BodyMechanix</title>
        <meta
          name="description"
          content="Explore additional tools, resources, and fitness calculators to optimize your workout and wellness journey at BodyMechanix."
        />
        <meta
          name="keywords"
          content="BodyMechanix, fitness tools, fitness resources, fitness calculators, BMI calculator, calorie calculator, body fat calculator, wellness tools"
        />
        <meta name="author" content="BodyMechanix" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta property="og:url" content="https://www.bodymechanix.com/more" />
        ...
        <div className={styles.banner}>
          <div className={styles.bannerContent}>
            ...
            <p className={styles.subtitle}>
              Discover expert tips, workout routines, nutrition advice and
              success stories to help you achieve your fitness goals
            </p>
