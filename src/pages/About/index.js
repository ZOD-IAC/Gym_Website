...
function About() {
  ...
  return (
    <>
      <Head>
        <title>About Us - BodyMechanix</title>
        <meta
          name="description"
          content="Learn more about BodyMechanix, our mission, vision, and the services we provide. Discover why we are passionate about helping you achieve your fitness and health goals."
        />
        <meta
          name="keywords"
          content="About Us, Gym Mission, Fitness Services, Health Goals, Fitness Journey, Gym Vision"
        />
        ...
        <div className={styles.banner}>
          <div className={styles.bannerContent}>
            ...
            <p className={styles.subtitle}>
              Learn about our mission to help people transform their lives
              through fitness, expert guidance, and a supportive community
          ...
          <div className={styles.TextContent}>
            <div className={styles.content}>
              ...
              <p>
                ...
                beginners to advanced athletes, can thrive. We don’t just focus
                on building strength; we focus on building confidence,
            ...
            <div className={styles.content}>
              ...
              <p>
                ...
                Whether it’s achieving a personal best, staying active, or
                simply finding a place to unwind, our gym is designed to meet
                your needs.
              </p>
            </div>
            <div className={styles.content}>
            ...
            <div className={styles.content}>
              ...
              <p>
                ...
                weight, build muscle, improve flexibility, or enhance your
                overall health, we’re committed to helping you succeed. Our team
                of experienced trainers and staff are here to provide the
                guidance, support, and accountability you need to reach your
                full potential.
              </p>
            </div>
            <div className={styles.content}>
              ...
              <p>
                Our gym is thoughtfully designed to cater to your fitness
                journey. From the spacious workout areas and cutting-edge
                equipment to the clean and modern locker rooms, every detail is
                crafted to ensure your experience is comfortable and inspiring.
                We aim to provide a space where you feel motivated to reach your
                goals.
              </p>
            </div>
            <div className={styles.content}>
              ...
              <p>
                ...
                just starting out or looking to challenge yourself further,
                you’ll find a program that suits you.
              </p>
            </div>
            <div className={styles.content}>
