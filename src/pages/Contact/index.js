...
function Contact() {
  ...
  return (
    <>
      <Head>
        <title>Contact Us - BodyMechanix</title>
        <meta
          name="description"
          content="Get in touch with Elite Fitness Center. Contact us for gym memberships, personal training sessions, or any other inquiries. We're here to help!"
        />
        ...
        <meta
          name="keywords"
          content="contact, gym, fitness, personal training, gym memberships, Elite Fitness Center"
        />
        <meta name="author" content="Elite Fitness Center" />
      ...
      <div className={styles.container}>
        <div className={styles.banner}>
          <div className={styles.bannerContent}>
            ...
            <p className={styles.subtitle}>
              Have questions about our fitness programs or want to start your
        ...
        <div className={styles.contactContent} ref={ref}>
          <div className={styles.contactInfo}>
            <div className={styles.infoItem}>
              <h3>Location</h3>
              <p>Body Mechanix Gym,A-144,sec.8 Dwarka</p>
              <p>Delhi, India 110077</p>
            </div>
        ...
        <div className={styles.mapPlaceholder}>Map Integration</div>
        </div>
        </div> */}
      </div>
    </>
